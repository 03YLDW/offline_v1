...
location '/2207A/zhengwei_zhou/gmall/ods/ods_order_info/'
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_order_detail/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_sku_info/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_user_info/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_base_category1/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_base_category2/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_base_category3/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_payment_info/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
row format delimited fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/dwd/dwd_comment_log/'
tblproperties ("parquet.compression"="snappy")
;


load data inpath '/2207A/zhengwei_zhou/dwd_comment_log/2025-03-23'
...
row format delimited fields terminated by '\t'
location '/2207A/zhengwei_zhou/gmall/ods/ods_comment_info'
tblproperties ("parquet.compression"="snappy");
...
row format delimited fields terminated by '\t'
stored as parquet
location '/2207A/zhengwei_zhou/gmall/dwd/dwd_comment_info'
tblproperties ("parquet.compression"="snappy");
...
PARTITIONED BY ( `dt` string)
stored as  parquet
location '/2207A/zhengwei_zhou/gmall/dwd/dwd_order_info/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
stored as  parquet
location '/2207A/zhengwei_zhou/gmall/dwd/dwd_order_detail/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
stored as  parquet
location '/2207A/zhengwei_zhou/gmall/dwd/dwd_user_info/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
stored as  parquet
location '/2207A/zhengwei_zhou/gmall/dwd/dwd_payment_info/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
stored as  parquet
location '/2207A/zhengwei_zhou/gmall/dwd/dwd_sku_info/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
stored as  parquet
location '/2207A/zhengwei_zhou/gmall/dws/dws_user_action/'
tblproperties ("parquet.compression"="snappy");
--3.5.2 向用户行为宽表导入数据
