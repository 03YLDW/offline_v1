create database if not exists db_gmall;
use db_gmall;
...
location '/user/hive/db_gmall/ods/ods_order_info/'
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_order_detail/'
tblproperties ("parquet.compression"="GZIP")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_sku_info/'
tblproperties ("parquet.compression"="GZIP")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_user_info/'
tblproperties ("parquet.compression"="GZIP")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_base_category1/'
tblproperties ("parquet.compression"="GZIP")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_base_category2/'
tblproperties ("parquet.compression"="GZIP")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_base_category3/'
tblproperties ("parquet.compression"="GZIP")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_payment_info/'
tblproperties ("parquet.compression"="GZIP")
;
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ods/ods_comment_info/'
tblproperties ("parquet.compression"="GZIP")
;


load data inpath '/origin_data/db/order_info/2025-03-24'  OVERWRITE into table ods_order_info partition(dt='2025-03-25');
load data inpath '/origin_data/db/order_detail/2025-03-24'  OVERWRITE into table ods_order_detail partition(dt='2025-03-25');
load data inpath '/origin_data/db/sku_info/2025-03-24'  OVERWRITE into table ods_sku_info partition(dt='2025-03-25');
load data inpath '/origin_data/db/user_info/2025-03-24' OVERWRITE into table ods_user_info partition(dt='2025-03-25');
load data inpath '/origin_data/db/payment_info/2025-03-24' OVERWRITE into table ods_payment_info partition(dt='2025-03-25');
load data inpath '/origin_data/db/base_category1/2025-03-24' OVERWRITE into table ods_base_category1 partition(dt='2025-03-25');
load data inpath '/origin_data/db/base_category2/2025-03-24' OVERWRITE into table ods_base_category2 partition(dt='2025-03-25');
load data inpath '/origin_data/db/base_category3/2025-03-24' OVERWRITE into table ods_base_category3 partition(dt='2025-03-25');
load data inpath '/origin_data/db/comment_info/2025-03-24' OVERWRITE into table ods_comment_info partition(dt='2025-03-25');
...
PARTITIONED BY ( `dt` string)
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/dws/dws_user_action/'
tblproperties ("parquet.compression"="snappy")
;
...
PARTITIONED BY ( `dt` string)
stored as  parquet
location '/user/hive/db_gmall/dws/dws_user_sale_detail_daycount/'
tblproperties ("parquet.compression"="snappy");
...
row format delimited  fields terminated by '\t'
location '/user/hive/db_gmall/ads/ads_gmv_sum_day/'
;
